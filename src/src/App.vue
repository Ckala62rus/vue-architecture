...
<!--  <tmp-main-page v-if="true"/>-->
<!--  <tmp-login-page v-if="false"/>-->
    <!--end::Main-->
  <div id="app">
    <!--begin::Main-->
    <router-view/>
...
<!--            &lt;!&ndash;begin::Aside toggler&ndash;&gt;-->
<!--            <div id="kt_aside_toggle" class="btn btn-icon w-auto px-0 btn-active-color-primary aside-toggle" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize">-->
<!--              &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Navigation/Angle-double-left.svg&ndash;&gt;-->
...
<!--            </div>-->
<!--            &lt;!&ndash;end::Aside toggler&ndash;&gt;-->
<!--          </div>-->
<!--          &lt;!&ndash;end::Brand&ndash;&gt;-->
<!--          &lt;!&ndash;begin::Aside menu&ndash;&gt;-->
...
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Design/PenAndRuller.svg&ndash;&gt;-->
...
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Code/Compiling.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--															<span class="bullet bullet-dot"></span>-->
<!--														</span>-->
<!--                            <span class="menu-title">My Porjects</span>-->
<!--                          </a>-->
<!--                        </div>-->
<!--                        <div class="menu-item">-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/General/User.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--														<polygon points="0 0 24 0 24 24 0 24" />-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Lock.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Design/Substract.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Layout/Layout-4-blocks.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Group.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Shopping/Cart4.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Shopping/Credit-card.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--														<rect x="0" y="0" width="24" height="24" />-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Group-chat.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--									<span class="menu-link">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Shopping/Box2.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--														<rect x="0" y="0" width="24" height="24" />-->
...
<!--													<span class="bullet bullet-dot"></span>-->
<!--												</span>-->
<!--                        <span class="menu-title">None</span>-->
<!--                      </a>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                </div>-->
...
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Settings-02.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Layout/Layout-arrange.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--														<rect x="0" y="0" width="24" height="24" />-->
...
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Home/Library.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--														<rect x="0" y="0" width="24" height="24" />-->
...
<!--                      &lt;!&ndash;end::Svg Icon&ndash;&gt;-->
<!--										</span>-->
<!--                    <span class="menu-title">Documentation v8.0.3</span>-->
<!--                  </a>-->
<!--                </div>-->
<!--                <div class="menu-item">-->
<!--                  <a class="menu-link" href="documentation/getting-started/changelog.html">-->
<!--										<span class="menu-icon">-->
<!--											&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Files/File.svg&ndash;&gt;-->
<!--											<span class="svg-icon svg-icon-2">-->
<!--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--														<polygon points="0 0 24 0 24 24 0 24" />-->
...
<!--                </div>-->
<!--              </div>-->
<!--              &lt;!&ndash;end::Aside mobile toggle&ndash;&gt;-->
<!--              &lt;!&ndash;begin::Mobile logo&ndash;&gt;-->
<!--              <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">-->
<!--                <a href="index.html" class="d-lg-none">-->
<!--                  <img alt="Logo" src="assets/media/logos/logo-3.svg" class="h-30px" />-->
<!--                </a>-->
<!--              </div>-->
<!--              &lt;!&ndash;end::Mobile logo&ndash;&gt;-->
<!--              &lt;!&ndash;begin::Wrapper&ndash;&gt;-->
<!--              <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">-->
<!--                &lt;!&ndash;begin::Navbar&ndash;&gt;-->
...
<!--                          </div>-->
<!--                          <div class="menu-item">-->
<!--                            <a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html">-->
<!--															<span class="menu-icon">-->
<!--																&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Settings-02.svg&ndash;&gt;-->
<!--																<span class="svg-icon svg-icon-2">-->
<!--																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--                  &lt;!&ndash;begin::Toolbar wrapper&ndash;&gt;-->
<!--                  <div class="d-flex align-items-stretch flex-shrink-0">-->
...
<!--                            &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/General/Search.svg&ndash;&gt;-->
...
<!--																&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Navigation/Close.svg&ndash;&gt;-->
...
<!--                                  &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Code/Settings4.svg&ndash;&gt;-->
<!--                                  <span class="svg-icon svg-icon-1">-->
<!--																		<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--                                  &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Navigation/Angle-down.svg&ndash;&gt;-->
<!--                                  <span class="svg-icon svg-icon-2">-->
<!--																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--																				<polygon points="0 0 24 0 24 24 0 24" />-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Clipboard-list.svg&ndash;&gt;-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Media/Equalizer.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--																					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--																						<rect x="0" y="0" width="24" height="24" />-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Computers/Monitor.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
<!--																					<g opacity="0.25">-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Charts/Scatter-Up.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
<!--																					<g opacity="0.25">-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Charts/Doughnut.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Charts/Stacked-Area-Down.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Contacts/Envelope.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Business/Bank.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--                                  <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Charts/Line-03-Up.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">-->
...
<!--                                &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Files/File-Search.svg&ndash;&gt;-->
...
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Activities&ndash;&gt;-->
<!--                    &lt;!&ndash;begin::Quick links&ndash;&gt;-->
<!--                    <div class="d-flex align-items-center ms-1 ms-lg-3">-->
<!--                      &lt;!&ndash;begin::Menu&ndash;&gt;-->
...
<!--                              &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Shopping/Euro.svg&ndash;&gt;-->
...
<!--                              &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Mail-attachment.svg&ndash;&gt;-->
<!--                              <span class="svg-icon svg-icon-3x svg-icon-success mb-2">-->
<!--																<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--														</svg>-->
<!--													</span>-->
<!--                            &lt;!&ndash;end::Svg Icon&ndash;&gt;</a>-->
<!--                        </div>-->
<!--                        &lt;!&ndash;end::View more&ndash;&gt;-->
<!--                      </div>-->
<!--                      &lt;!&ndash;end::Menu&ndash;&gt;-->
<!--                      &lt;!&ndash;end::Menu&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Quick links&ndash;&gt;-->
...
<!--                        </div>-->
<!--                        &lt;!&ndash;end::Heading&ndash;&gt;-->
<!--                        &lt;!&ndash;begin::Tab content&ndash;&gt;-->
<!--                        <div class="tab-content">-->
<!--                          &lt;!&ndash;begin::Tab panel&ndash;&gt;-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Clothes/Crown.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Code/Warning-2.svg&ndash;&gt;-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/General/Thunder.svg&ndash;&gt;-->
...
<!--                                  <div class="symbol symbol-35px me-4">-->
<!--																		<span class="symbol-label bg-light-primary">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Flag.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Design/Image.svg&ndash;&gt;-->
...
<!--                                  <div class="symbol symbol-35px me-4">-->
<!--																		<span class="symbol-label bg-light-warning">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Design/Component.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-warning">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--                              <img class="mh-200px" alt="metronic" src="assets/media/svg/illustrations/work.svg" />-->
...
<!--                                  &lt;!&ndash;begin::Code&ndash;&gt;-->
<!--                                  <span class="w-70px badge badge-light-success me-4">200 OK</span>-->
<!--                                  &lt;!&ndash;end::Code&ndash;&gt;-->
<!--                                  &lt;!&ndash;begin::Title&ndash;&gt;-->
...
<!--                    &lt;!&ndash;begin::Heaeder menu toggle&ndash;&gt;-->
...
<!--                        &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Text/Toggle-Right.svg&ndash;&gt;-->
<!--                        <span class="svg-icon svg-icon-1">-->
<!--													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--															<rect x="0" y="0" width="24" height="24" />-->
...
<!--                      </div>-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Heaeder menu toggle&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Toolbar wrapper&ndash;&gt;-->
<!--                </div>-->
...
<!--                    &lt;!&ndash;end::Description&ndash;&gt;</h1>-->
<!--                  &lt;!&ndash;end::Title&ndash;&gt;-->
<!--                </div>-->
...
<!--                      &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Text/Filter.svg&ndash;&gt;-->
...
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xxl-4">-->
<!--                    &lt;!&ndash;begin::Mixed Widget 2&ndash;&gt;-->
...
<!--                            &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Layout/Layout-4-blocks-2.svg&ndash;&gt;-->
<!--                            <span class="svg-icon svg-icon-2">-->
<!--															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
...
<!--                              &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Add-user.svg&ndash;&gt;-->
...
<!--                              &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Design/Layers.svg&ndash;&gt;-->
...
<!--                              &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Urgent-mail.svg&ndash;&gt;-->
...
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Mixed Widget 2&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xxl-4">-->
<!--                    &lt;!&ndash;begin::List Widget 5&ndash;&gt;-->
<!--                    <div class="card card-xxl-stretch">-->
<!--                      &lt;!&ndash;begin::Header&ndash;&gt;-->
...
<!--                            </div>-->
<!--                            &lt;!&ndash;end::Badge&ndash;&gt;-->
<!--                            &lt;!&ndash;begin::Desc&ndash;&gt;-->
<!--                            <div class="timeline-content fw-bolder text-gray-800 ps-3">Make deposit-->
<!--                              <a href="#" class="text-primary">USD 700</a>. to ESL</div>-->
<!--                            &lt;!&ndash;end::Desc&ndash;&gt;-->
<!--                          </div>-->
<!--                          &lt;!&ndash;end::Item&ndash;&gt;-->
<!--                          &lt;!&ndash;begin::Item&ndash;&gt;-->
<!--                          <div class="timeline-item">-->
...
<!--                    </div>-->
<!--                    &lt;!&ndash;end: List Widget 5&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xxl-4">-->
<!--                    &lt;!&ndash;begin::Mixed Widget 7&ndash;&gt;-->
...
<!--                      &lt;!&ndash;end::Body&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Mixed Widget 7&ndash;&gt;-->
<!--                    &lt;!&ndash;begin::Mixed Widget 10&ndash;&gt;-->
<!--                    <div class="card card-xxl-stretch-50 mb-5 mb-xl-8">-->
<!--                      &lt;!&ndash;begin::Body&ndash;&gt;-->
...
<!--                              &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Shopping/Chart-line1.svg&ndash;&gt;-->
...
<!--                      </div>-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Mixed Widget 10&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                </div>-->
<!--                &lt;!&ndash;end::Row&ndash;&gt;-->
...
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xxl-4">-->
<!--                    &lt;!&ndash;begin::List Widget 3&ndash;&gt;-->
...
<!--                      &lt;!&ndash;end::Body&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end:List Widget 3&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xl-8">-->
<!--                    &lt;!&ndash;begin::Tables Widget 9&ndash;&gt;-->
...
<!--                        &lt;!&ndash;begin::Table container&ndash;&gt;-->
...
<!--                                  &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/General/Settings-1.svg&ndash;&gt;-->
<!--                                  <span class="svg-icon svg-icon-3">-->
<!--																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--																					<rect x="0" y="0" width="24" height="24" />-->
...
<!--                                </a>-->
<!--                                <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">-->
<!--                                  &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Communication/Write.svg&ndash;&gt;-->
<!--                                  <span class="svg-icon svg-icon-3">-->
<!--																			<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
...
<!--                                  &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/General/Trash.svg&ndash;&gt;-->
<!--                                  <span class="svg-icon svg-icon-3">-->
<!--																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--																					<rect x="0" y="0" width="24" height="24" />-->
...
<!--                      &lt;!&ndash;begin::Body&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Tables Widget 9&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                </div>-->
<!--                &lt;!&ndash;end::Row&ndash;&gt;-->
...
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xl-4">-->
<!--                    &lt;!&ndash;begin::List Widget 2&ndash;&gt;-->
...
<!--                      &lt;!&ndash;end::Body&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::List Widget 2&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xl-4">-->
<!--                    &lt;!&ndash;begin::List Widget 6&ndash;&gt;-->
<!--                    <div class="card card-xl-stretch mb-xl-8">-->
<!--                      &lt;!&ndash;begin::Header&ndash;&gt;-->
<!--                      <div class="card-header border-0">-->
...
<!--                      &lt;!&ndash;end::Body&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::List Widget 6&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xl-4">-->
<!--                    &lt;!&ndash;begin::List Widget 4&ndash;&gt;-->
...
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xxl-4">-->
<!--                    &lt;!&ndash;begin::Mixed Widget 5&ndash;&gt;-->
<!--                    <div class="card card-xxl-stretch mb-xl-3">-->
<!--                      &lt;!&ndash;begin::Beader&ndash;&gt;-->
...
<!--                      &lt;!&ndash;end::Body&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Mixed Widget 5&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                  &lt;!&ndash;begin::Col&ndash;&gt;-->
<!--                  <div class="col-xxl-8">-->
<!--                    &lt;!&ndash;begin::Tables Widget 5&ndash;&gt;-->
...
<!--                                      &lt;!&ndash;begin::Svg Icon | path: icons/stockholm/Navigation/Arrow-right.svg&ndash;&gt;-->
<!--                                      <span class="svg-icon svg-icon-2">-->
<!--																					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--																						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
<!--																							<polygon points="0 0 24 0 24 24 0 24" />-->
...
<!--                      &lt;!&ndash;end::Body&ndash;&gt;-->
<!--                    </div>-->
<!--                    &lt;!&ndash;end::Tables Widget 5&ndash;&gt;-->
<!--                  </div>-->
<!--                  &lt;!&ndash;end::Col&ndash;&gt;-->
<!--                </div>-->
<!--                &lt;!&ndash;end::Row&ndash;&gt;-->
...
// import TmpMainPage from "@/views/template/MainPage";
