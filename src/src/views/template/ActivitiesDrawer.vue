<template>
  <div id="kt_activities" class="bg-white" data-kt-drawer="true" data-kt-drawer-name="activities"
       ...
       data-kt-drawer-width="{default:'300px', 'lg': '500px'}" data-kt-drawer-direction="end"
          ...
          <div class="timeline">
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="pe-3 mb-5">
                  <!--begin::Title-->
                  <div class="fs-5 fw-bold mb-2">There are 2 new tasks for you in “AirPlus Mobile APp” project:
                  </div>
                  <!--end::Title-->
                  <!--begin::Description-->
                  ...
                  <div
                    ...
                    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                      ...
                      <div class="mb-3 mb-md-0 fw-bold">
                        ...
                        <div class="fs-6 text-gray-600 pe-7">Login into Metronic Admin Dashboard to make sure the
                          data
                          integrity is OK
                        </div>
                      </div>
