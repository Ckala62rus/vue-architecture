              ...
              <form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
                          ...
                          <span class="d-flex align-items-center me-2">
															...
															<span class="symbol symbol-50px me-6">
																<span class="symbol-label bg-light-success">
																	<!--begin::Svg Icon | path: icons/stockholm/Devices/Watch1.svg-->
                  ...
                  <div class="w-100">
                    ...
                    <div class="d-flex flex-stack">
                      ...
                      <div class="me-5">
                        ...
                        <div class="fs-7 fw-bold text-gray-400">If you need more info, please check budget planning
                        </div>
                      </div>
                      <!--end::Label-->
                      <!--begin::Switch-->
                ...
                <div data-kt-stepper-element="content">
                  <div class="w-100 text-center">
                    ...
                    <!--begin::Illustration-->
                    <div class="py-15">
                      <img src="assets/media/svg/illustrations/todo.svg" alt="" class="mx-auto w-100 mh-150px"/>
                    </div>
                    <!--end::Illustration-->
                  </div>
                </div>
